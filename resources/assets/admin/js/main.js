...
$(document).ready(function () {
    ...
    *
    ...
    $('.region').click(function () {
        ...
        $('.updateId').val($(this).next('.idRegion').html());

        $('#region').prop('selectedIndex', 0);
        $("#region :first").prop('selected', true)
    });

    $('.city').click(function () {

        $('#location').val($(this).children('.location').html());
        $('#auto').val($(this).children('.auto').html());
        $('#tractor').val($(this).children('.tractor').html());

        $('.updateId').val($(this).children('.city_id').html());

        $('#region').prop('selectedIndex', 0);
        $('#region option[value=' + $(this).children('.region_id').html() + ']').prop('selected', true)
    });
